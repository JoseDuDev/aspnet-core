...
using docspider.Sessions;
using docspider.Web.Models.Account;
using docspider.Web.Views.Shared.Components.TenantChange;

namespace docspider.Web.Controllers
{
    public class AccountController : docspiderControllerBase
    {
